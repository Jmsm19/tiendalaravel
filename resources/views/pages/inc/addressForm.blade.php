{!! Form::open(array('route' => 'address.store', 'method' => 'POST', 'class' => 'form')) !!}
  ...
  <div class="form-group">
    ...
    {!! Form::text('address1', null, ['class' => 'form-control', 'placeholder' => 'Street and number, P.O. box, etc.', 'required']) !!}
  </div>

  <div class="form-group">
    {!! Form::text('address2', null, ['class' => 'form-control', 'placeholder' => 'Appartment, suite, unit, building, floor, etc.', 'required']) !!}
  </div>
